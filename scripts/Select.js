...
class Select extends BaseComponent {
    ...
    updateUI() {
        ...
        const updateOptions = () => {
            this.optionElement.forEach((optionElement, i) => {
                const isCurrent = currentOptionIndex === i
    ...
    get isNeedToExpand() {
        const isButtonFocuses = document.activeElement === this.buttonElement

        return (!this.state.isExpanded && isButtonFocuses)
    }
